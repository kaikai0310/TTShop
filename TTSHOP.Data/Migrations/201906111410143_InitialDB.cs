                ...
                c => new
                    {
                        ...
                        CustomerAddress = c.String(nullable: false, maxLength: 150),
                        CustomerEmail = c.String(nullable: false, maxLength: 70),
                        CustomerMobile = c.String(nullable: false, maxLength: 70),
                ...
                c => new
                    {
                        ...
                        Description = c.String(maxLength: 256),
                        Content = c.String(),
                        HomeFlat = c.Boolean(nullable: false),
                        HotFlat = c.Boolean(nullable: false),
                        CreateDate = c.DateTime(),
                        CreateBy = c.String(maxLength: 256),
                        UpdateDate = c.DateTime(),
                        UpdateBy = c.String(maxLength: 256),
